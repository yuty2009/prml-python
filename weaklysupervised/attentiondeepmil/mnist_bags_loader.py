...
class MnistBags(data_utils.Dataset):
    def __init__(
        self, root='../datasets', target_number=9, mean_bag_length=10,
        var_bag_length=1, num_bag=1000, seed=7, train=True):
...
if __name__ == "__main__":
    ...
    train_loader = data_utils.DataLoader(MnistBags(root='../datasets',
                                                   target_number=9,
                                                   mean_bag_length=10,
                                                   var_bag_length=2,
                                                   num_bag=100,
    ...
    test_loader = data_utils.DataLoader(MnistBags(root='../datasets',
                                                   target_number=9,
                                                  mean_bag_length=10,
                                                  var_bag_length=2,
                                                  num_bag=10,
